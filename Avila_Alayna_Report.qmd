...
Below in #figure-summary, is the data summary of the `games` data. There are `50,000` video games, `35` variables, `11` of which are character and the remaining `24` are numeric. However, I noticed most of the numeric and character variables would be more insightful as factor variables. Before cleansing the variable type, I did a check for missing information. According to @fig-miss, there is no information missing from the data, and I can continue on with cleansing the variable types. As shown in #figure-summary-2 
...
![Missingness Plot](figures/missing_plot.png){#fig-miss}
